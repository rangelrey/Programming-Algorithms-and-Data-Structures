...
{ //This class contains the common test methods
    ...
    public static void testEqualData2 (Data result) {
    ...
    public static void testEqualTreeNode (TreeNode result, TreeNode expected) {
        if (result.equals (expected)) {   // Strings are objects, so use the equals method
            System.out.println("Test was successful!");
    ...
    public static void testEqualListNode (ListNode  result, ListNode  expected) {
        if (result.equals (expected)) {   // Strings are objects, so use the equals method
            System.out.println("Test was successful!");
     ...
     public static void testEqualHashMap (HashMap<String,List>  result, HashMap<String,List>   expected) {
        if (result.equals (expected)) {   // Strings are objects, so use the equals method
            System.out.println("Test was successful!");
