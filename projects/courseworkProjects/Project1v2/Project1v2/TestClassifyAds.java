...
{    public static void main() {
        ...
        //assign each ad where it should belong in the tree
        ClassifyAds.insertAdsInTree(startingList, tree);

        
        List testFrList = new List();
        testFrList.join(ad1);
        testFrList.join(ad2);
        
         List testInList = new List();
         testInList.join(ad4);
