public class TestTourFinder extends TestFramework
{
    public static void testEulerianGraph() {
        ...
        List<GNode> circuit = TourFinder.findTour(graph,exclusions);

        testEqualStrings(circuit.toString(),"[1, 6, 5, 4, 3, 2]");  
    }

    public static void testEulerianNotConnectedGraph() {
        ...
        String[] exclusions = new String[]{"xxx"};
    ...
    public static void testEulerianNotCircularGraph() {
        Audible holocaust = new Audible("Explanation of the murder, torture and violence in concentration camps in WW2", "7");
        Text treatyOfPeace = new Text("Copy of the final peace treaty between allies", "2");
        Text memories = new Text("memories of a mother missing his child during the war","3");
        Visual introduction = new Visual("Video: Introduction to the WW2 museum","1");
        ...
        graph.addUndirectedLink (node1, node2);
        graph.addUndirectedLink (node1, node3);
        graph.addUndirectedLink (node2, node4);
        graph.addUndirectedLink (node4, node3);
        graph.addUndirectedLink (node3, node5);
        graph.addUndirectedLink (node6, node5);
        graph.addUndirectedLink (node3, node6);

        String[] exclusions = new String[]{"xxxxxx"};

        List<GNode> circuit = TourFinder.findTour(graph,exclusions);
        System.out.println(circuit.toString());
        testEqualStrings(circuit.toString(),"[1, 3, 6, 5, 3, 4, 2]");  
    }
    ...
    public static void testNonEulerianGraph() {
        ...
        System.out.println("Circuit:"+ TourFinder.findTour(graph,exclusions).toString());
